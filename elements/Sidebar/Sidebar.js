    ...
    <div className="flex flex-col h-screen py-8 w-2/12 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          {/* <a
            className="flex items-center px-4 py-2 text-gray-700 rounded-md border-2 border-blue-600 dark:bg-gray-700 dark:text-gray-200"
            href="dsa"
          >
            <svg
              className="w-5 h-5"
            ...
            <span className="mx-4 font-medium">DSA</span>
          </a>

          <a
            className="flex items-center px-4 py-2 mt-2 text-gray-600 transition-colors duration-200 transform dark:text-gray-400 hover:bg-blue-200 rounded dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700"
            href="/design"
          >
            <svg
              className="w-5 h-5"
            ...
            <span className="mx-4 font-medium">System Design</span>
          </a>
          ...
          >
            ...
            <span className="mx-4 font-medium">Resources</span>
          </a> */}
        </nav>
      </div>
    </div>
